...
virtual bool attr_redefine_error(SymbolTable<Symbol, Entry> *) = 0;\
virtual int method_redefine_error(SymbolTable<Symbol, Feature_class> *, Symbol, ClassTable *) = 0;\
...
Symbol get_name();\
Symbol get_type();\
bool attr_redefine_error(SymbolTable<Symbol, Entry> *);\
int method_redefine_error(SymbolTable<Symbol, Feature_class> *, Symbol, ClassTable *);\
...
bool method_formal_no_type_error(Formal, Class_, ClassTable *);
